    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 h-[92px] flex items-center justify-center z-[200] backdrop-blur-[5px] bg-transparent"
          style={{
        ...
        >
          ...
          >
            ...
            <div className='text-[16px] font-semibold mt-[4px] text-white mb-[20px]'>start with "Hey Mentra"</div>
          </h2>
        </motion.div>
      )}
    </AnimatePresence>
